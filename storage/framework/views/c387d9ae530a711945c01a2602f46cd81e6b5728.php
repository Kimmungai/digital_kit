<?php $__env->startSection('main'); ?>
  ...
  <main ng-show="active_tool==2 && tool_B==true">
    ...
    <ul class="list-inline text-center mt-2">
      <li class="list-inline-item"><a class="btn btn-primary btn-sm" href="<?php echo e(url('/download-card')); ?>" target="_blank"><span class="fa fa-download"></span> Download</a></li>
    ...
    <!--<ul class="list-inline text-center mt-2">
      <li class="list-inline-item"><a href="<?php echo e(url('/download-card')); ?>" style="text-decoration:none;color:inherit;" target="_blank"><span class="fa fa-download"></span> Download</a></li>
          ...
          <div class="col-md-4 mb-3" ng-repeat="post in all_posts | filter:q | startFrom:currentPage*pageSize | limitTo:pageSize">
            <div class="card">
              ...
              <div class="card-body">
                 ...
                 <!--<a href="<?php echo e(url('/')); ?>/blog/<% post.id %>" class="btn btn-sm btn-info float-right">Read more <i class="fas fa-angle-double-right"></i></a>-->
              </div>
            </div>
          </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 d-none d-sm-block">
          <div class="song-form-image" style="background-image:url(<?php echo e(url('/css/guitar.jpg')); ?>)">
  ...
  <main ng-show="active_tool==5">
    ...
    function update_payment_details_value(paymentID,value){
      $.get("<?php echo e(url('/payment-values-update')); ?>",
        {
          paymentID:paymentID,
          value:value
        },
    ...
    function record_payment(paymentID,paymentAmt,paymentProvider,prev_acc_bal){
      $.post("<?php echo e(url('/record-payment')); ?>",
        {
          paymentID:paymentID,
  ...
  <div id="wait" style="display:none;width:32px;height:32px;border:1px solid black;position:absolute;top:50%;left:50%;padding:2px;"><img src='<?php echo e(url("/img/loading.gif")); ?>' width="64" height="64" /><br>Loading..</div>
