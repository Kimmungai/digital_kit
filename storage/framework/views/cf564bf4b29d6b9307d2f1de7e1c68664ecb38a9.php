...
<html lang="en" dir="ltr" ng-app="App" ng-controller="Ctrl">
  <head>
    ...
    <link  href="<?php echo e(url('/css/new_style.css')); ?>" rel="stylesheet">
    <link  href="<?php echo e(url('/css/website.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(url('/css/ssi-uploader.min.css')); ?>" rel="stylesheet"/>
...
<!-- End Load Facebook SDK for JavaScript -->
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-6">
            <div class="card bg-dark text-white hidden-sm-down">
              <img class="card-img img-responsive rounded" src="<?php echo e(url('img/help-bg.jpg')); ?>"  style="width:100%;height:100%;filter:brightness(30%);">
        ...
        <header><!--start of header section-->
          <div class="col-md-12">
            <div class="container-fluid">
              <div class="row">
                <div class="col-md-8">
                  <h1 class="text-warning"><a href="<?php echo e(url('/')); ?>">biznessKit</a></h1>
                </div>
                <div class="col-md-4">
      ...
      <div class="row">
        <footer class="bg-dark">
          <div class="container">
            <div class="row">
              <div class="col-md-4">
                <h2>&copy;<?php echo e(date('Y')); ?> All rights reserved</h2>
              </div>
              <div class="col-md-4">
              </div>
              <div class="col-md-4">
    ...
    <script src="<?php echo e(url('/js/ssi-uploader.min.js')); ?>"></script>
    <script src="<?php echo e(url('/js/main.js')); ?>"></script>
  </body>
</html>

<?php echo $__env->make('templates.angular-variables', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>