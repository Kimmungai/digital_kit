		...
		<div class="music-cart">
			<div class="music-cart-left">
				<nav class="navbar navbar-expand-lg navbar-light bg-none music-nav">
					<a class="navbar-brand" href="index.php?id=<?php echo $_GET['id'];?>" style="font-size:1.2em"><?php echo $saved_data['first_name']; ?> <?php echo $saved_data['last_name']; ?></a>
					<div class="music-cart">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
							<li class="nav-item">
								<a class="nav-link" href="index.php?id=<?php echo $_GET['id'];?>#one"><?php echo $saved_data['about_title']; ?></a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="index.php?id=<?php echo $_GET['id'];?>#three"><?php echo $saved_data['speciality_title']; ?></a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="index.php?id=<?php echo $_GET['id'];?>#cta"><?php echo $saved_data['contact_section_title']; ?></a>
							</li>
							<li class="nav-item active">
								<a class="nav-link" href="shop.php?id=<?php echo $_GET['id'];?>">Music Store <span class="sr-only">(current)</span></a>
							</li>
