<?php include_once('../db.php');include_once('../PesapalAPI/OAuth.php'); ?>
<!DOCTYPE html>
...
//echo "Reference: ".$reference = $_GET['pesapal_merchant_reference'];
//if(isset($_GET['pesapal_transaction_tracking_id']))
//echo "Tracking Id: ".$pesapal_tracking_id = $_GET['pesapal_transaction_tracking_id'];
//if(isset($_GET['payment_status']))
//echo "Payment Status: ".$payment_status = $_GET['payment_status'];
