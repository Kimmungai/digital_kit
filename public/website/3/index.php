                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 template ">
                            <a href="<?php echo $saved_data['speciality_2_url']; ?>" target="_blank"><article class="template-design work-box wow bounceInDown center animated">
                        ...
                        <div class="col-lg-6 ui">
                            <a href="<?php echo $saved_data['speciality_3_url']; ?>" target="_blank"><article class="ui-design work-box wow bounceInUp center animated">
