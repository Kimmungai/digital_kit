					...
					<section id="two">
						...
						<div class="row">
							<article class="col-6 col-12-xsmall work-item">
								...
								<h3><strong><i class="icon fa <?php echo $saved_data['speciality_1_icon']; ?>"> </i> </strong><?php echo $saved_data['speciality_1']; ?></h3>
								<p><?php echo $saved_data['speciality_1_text']; ?></p>
							</article>
							<article class="col-6 col-12-xsmall work-item">
								<a href="images/fulls/02.jpg" class="image fit thumb"><img src="images/thumbs/02.jpg" alt="" /></a>
								<h3><strong><i class="icon fa <?php echo $saved_data['speciality_2_icon']; ?>"> </i> </strong><?php echo $saved_data['speciality_2']; ?></h3>
								<p><?php echo $saved_data['speciality_2_text']; ?></p>
							</article>
							<article class="col-6 col-12-xsmall work-item">
								<a href="images/fulls/03.jpg" class="image fit thumb"><img src="images/thumbs/03.jpg" alt="" /></a>
								<h3><strong><i class="icon fa <?php echo $saved_data['speciality_3_icon']; ?>"> </i> </strong><?php echo $saved_data['speciality_3']; ?></h3>
								<p><?php echo $saved_data['speciality_3_text']; ?></p>
							</article>
							<article class="col-6 col-12-xsmall work-item">
								<a href="images/fulls/04.jpg" class="image fit thumb"><img src="images/thumbs/04.jpg" alt="" /></a>
								<h3><strong><i class="icon fa <?php echo $saved_data['speciality_4_icon']; ?>"> </i> </strong><?php echo $saved_data['speciality_4']; ?></h3>
